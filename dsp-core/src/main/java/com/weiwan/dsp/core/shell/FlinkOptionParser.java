 ...
 * @description:
 */
public class FlinkOptionParser extends CommonOptionParser {
    ...
    public static final Options RUN_OPTIONS = getRunCommandOptions();
    ...
    public static Options getRunCommandOptions() {
        Options options = buildGeneralOptions(getCommonOptions());
    ...
    public static Options getCancelCommandOptions() {
        Options options = buildGeneralOptions(getCommonOptions());
        return options.addOption(CANCEL_WITH_SAVEPOINT_OPTION).addOption(JOB_ID_OPTION);
    }

    public static Options getStopCommandOptions() {
        return buildGeneralOptions(getCommonOptions())
                .addOption(STOP_WITH_SAVEPOINT_PATH)
                .addOption(STOP_AND_DRAIN)
                .addOption(JOB_ID_OPTION);
    }
    ...
    private static Options getStopOptionsWithoutDeprecatedOptions(Options options) {
        return options.addOption(STOP_WITH_SAVEPOINT_PATH).addOption(STOP_AND_DRAIN).addOption(JOB_ID_OPTION);
    }
    ...
    public static void printHelp(Collection<CustomCommandLine> customCommandLines) {
        System.out.println("dsp <ACTION> [OPTIONS] [ARGUMENTS]");
        System.out.println();
    ...
    public static void printHelpForRun(Collection<CustomCommandLine> customCommandLines) {
        ...
        formatter.printHelp(" ", getRunOptionsWithoutDeprecatedOptions(getCommonOptions()));
    ...
    public static void printHelpForInfo() {
        ...
        formatter.printHelp(" ", getInfoOptionsWithoutDeprecatedOptions(getCommonOptions()));
    ...
    public static void printHelpForList(Collection<CustomCommandLine> customCommandLines) {
        ...
        formatter.printHelp(" ", getListOptionsWithoutDeprecatedOptions(getCommonOptions()));
    ...
    public static void printHelpForStop(Collection<CustomCommandLine> customCommandLines) {
        ...
        formatter.printHelp(" ", getStopOptionsWithoutDeprecatedOptions(getCommonOptions()));
    ...
    public static void printHelpForCancel(Collection<CustomCommandLine> customCommandLines) {
        ...
        formatter.printHelp(" ", getCancelOptionsWithoutDeprecatedOptions(getCommonOptions()));
    ...
    public static void printHelpForSavepoint(Collection<CustomCommandLine> customCommandLines) {
        ...
        formatter.printHelp(" ", getSavepointOptionsWithoutDeprecatedOptions(getCommonOptions()));
    ...
    private static void printCustomCliOptions(
        ...
        for (CustomCommandLine cli : customCommandLines) {
            ...
            Options customOpts = getCommonOptions();
    ...
    public static Options getHelpOptions() {
        Options dspOptions = getCommonOptions();
        Options m1 = CommonOptionParser.mergeOptions(dspOptions, getRunCommandOptions());
        Options m2 = CommonOptionParser.mergeOptions(m1, getInfoCommandOptions());
        Options m3 = CommonOptionParser.mergeOptions(m2, getListCommandOptions());
        Options m4 = CommonOptionParser.mergeOptions(m3, getCancelCommandOptions());
        Options m5 = CommonOptionParser.mergeOptions(m4, getStopCommandOptions());
        Options m6 = CommonOptionParser.mergeOptions(m5, getSavepointCommandOptions());
        return m6;
    }
}
