package com.weiwan.dsp.console.exception;
...
public class GlobalExceptionHandler {
    ...
    public Result<Object> handleThrowable(HttpServletRequest request, Throwable e) {
        ...
        return Result.failure(DspResultStatus.INTERNAL_SERVER_ERROR, e);
    }
     ...
     * @return
     */
    @ExceptionHandler({DspConsoleException.class})
    public Result handleBusinessException(HttpServletRequest request, DspConsoleException e) {
        log.error("execute method exception error.url is {}", request.getRequestURI(), e);
        return Result.failure(e.getStatus(), e);
    }
    ...
    public Result handleJSR303Exception(HttpServletRequest request, Exception e) {
        ...
        Result result = Result.builder()
                .success(false)
                .code(DspResultStatus.PARAM_ERROR.getCode())
                .message(DspResultStatus.PARAM_ERROR.getMessage())
                .build();
    ...
    public Result handleSQLSyntaxErrorException(HttpServletRequest request, BadSqlGrammarException e) {
        ...
        return Result.failure(DspResultStatus.INTERNAL_SERVER_ERROR, message);
    }
    ...
    public Result handleUnauthorizedException(HttpServletRequest request, UnauthorizedException e) {
        ...
        log.error("execute method exception error.url is {}", request.getRequestURI(), e);
        return Result.failure(DspResultStatus.UNAUTHORIZED, message);
    }
